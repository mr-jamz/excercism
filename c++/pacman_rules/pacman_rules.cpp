...
// The function should return true if Pac-Man has eaten all of the dots and has not lost
bool won(bool has_eaten_all_dots, bool power_pellet_active,
    bool touching_ghost) {
    // TODO: Please implement the won function
    return (has_eaten_all_dots && !touching_ghost) || (has_eaten_all_dots && power_pellet_active && touching_ghost);
}