...
def win(has_eaten_all_dots, power_pellet_active, touching_ghost):
    ...
    return has_eaten_all_dots and power_pellet_active and touching_ghost or has_eaten_all_dots and power_pellet_active and not touching_ghost or has_eaten_all_dots and not power_pellet_active and not touching_ghost
